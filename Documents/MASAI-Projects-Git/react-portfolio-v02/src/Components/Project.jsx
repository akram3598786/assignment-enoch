...
let projectData = [
  ...
  },
  {
    ...
    desc: "Its a bike rental and e-commerce website. User can book bike and purchase products. Signup | Login | Payment Gateway | Animations.",
    team: "A collaborative project, built in 5 days by team of 3 members.",
  ...
  },
  {
    ...
    title: "Sudoku Solver",
    desc: "It is a web application where you can solve any sudoku of 9 * 9 Matrix",
    team: "Solo Project build in two hours",
